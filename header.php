...
<body>
    <div class="container">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-4"  id="logo">LOGO</div>
                <div class="col-lg-2 col-lg-offset-4" id="login">LOGIN</div>
                <div class="col-lg-2" id="reg">REGISTER</div>
            </div>
            <div class="row">
                <div class = "col-lg-12">
                           ...
                           <!-- Collect the nav links, forms, and other content for toggling -->
                            <div class="navbar-collapse collapse" >
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="#"><img class="cart-image" src="images/cart.svg" alt="Cart Icon" onmouseover="this.src='images/cart_hover.svg'" onmouseout="this.src='images/cart.svg'"></a></li>
                                    <li><a href="#"><img class="help-image" src="images/help.svg" alt="Help Icon" onmouseover="this.src='images/help_hover.svg'" onmouseout="this.src='images/help.svg'"></a></li>
                                </ul>
                            </div><!-- /.navbar-collapse -->
                        </div><!-- /.container-fluid -->
                    </div>
