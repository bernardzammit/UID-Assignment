    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <iframe width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3231.841067447281!2d14.484704999999993!3d35.90190799999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x130e454d8aa48a1b%3A0x4398993f6cadcf81!2sUniversity+of+Malta!5e0!3m2!1sen!2smt!4v1418232126303" ></iframe>
            </div>
            <div class="col-md-6">
                <h2>Our Location</h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Our Brands</h2>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6">
                <img class="img-responsive customer-img" src="images/brand-1.gif" alt="">
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6">
                <img class="img-responsive customer-img" src="images/brand-2.gif" alt="">
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6">
                <img class="img-responsive customer-img" src="images/brand-3.gif" alt="">
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6">
                <img class="img-responsive customer-img" src="images/brand-4.gif" alt="">
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6">
                <img class="img-responsive customer-img" src="images/brand-5.gif" alt="">
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6">
                <img class="img-responsive customer-img" src="images/brand-6.jpg" alt="">
            </div>
        </div>
        <!-- /.row -->
